#### CARL This is my verson of the script to import and clean up data from Moberly Lake Database
#### CARL I first used MDB Accdb viewer to convert the Access data to an excel workbook with separate worksheets
#### CARL for each table.
#### CARL Then just read these tables using readxl
...
# CARL ch <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
# CARL  	DBQ=C:/Users/kmpec/Documents/R/moberly/Moberly Fish Database-copydec62021.accdb")



# CARL sqlTables(ch,tableType = "TABLE")["TABLE_NAME"]
library(readxl)
# CARL effort <- sqlFetch(ch, "TABLE - Effort Information")
effort <- readxl::read_excel("Moberly Fish Database-MASTER.xlsx", sheet="TABLE - Effort Information")

# CARL env <- sqlFetch(ch,"TABLE - Environmental Info")
env   <- readxl::read_excel("Moberly Fish Database-MASTER.xlsx", sheet="TABLE - Environmental Info")

# CARL catch <- sqlFetch(ch,"TABLE - All Fish Capture Measurements")
catch <- readxl::read_excel("Moberly Fish Database-MASTER.xlsx", sheet="TABLE - All Fish Capture Measu…")# note truncation of table name

# CARL bycatch <- sqlFetch(ch,"TABLE - By-Catch Summary Capture Info")
bycatch <- readxl::read_excel("Moberly Fish Database-MASTER.xlsx", sheet="TABLE - By-Catch Summary Captu…")# note truncation of table name

# CARL LT.ID <-  sqlFetch(ch,"TABLE - Specific Fish ID Info", na.strings = "NA")
LT.ID <- readxl::read_excel("Moberly Fish Database-MASTER.xlsx", sheet="TABLE - Specific Fish ID Info")
